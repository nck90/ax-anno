...
export async function editFormatCommand(file, ref, options) {
    try {
        ...
        if (options.bold !== undefined)
            formatPayload.bold = options.bold;
        if (options.italic !== undefined)
            formatPayload.italic = options.italic;
        if (options.underline !== undefined)
            formatPayload.underline = options.underline;
        if (options.font !== undefined)
            formatPayload.fontName = options.font;
        if (options.size !== undefined)
            formatPayload.fontSize = options.size;
        if (options.color !== undefined)
            formatPayload.color = options.color;
